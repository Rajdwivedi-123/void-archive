...
const interactionCopy: Record<NexusInteractionId, { title: string; action: string; measure: string }> = {
  ...
  "n07-cross-threshold": { title: "N-07 BOUNDARY", action: "CROSS THRESHOLD", measure: "DEPTH / PHYSICAL" },
  "n07-topology-visible": { title: "VISIBLE ROUTE", action: "TEST ROUTE", measure: "DESTINATION / ABSENT" },
  "n07-topology-missing": { title: "MISSING ROUTE", action: "TRACE INTERVAL", measure: "TOPOLOGY / CONTRADICTORY" },
  "n07-stillness-seam": { title: "STILLNESS SEAM", action: "STABILIZE", measure: "MOTION / ZERO" },
  "n07-reflection-route": { title: "REFLECTION ROUTE", action: "CONFIRM", measure: "PHYSICAL RETURN / ABSENT" },
  "n07-trace-sync": { title: "OBSERVER TRACE", action: "SYNCHRONIZE", measure: "ROUTE / SHARED" },
  "n07-trace-diverge": { title: "OBSERVER TRACE", action: "DIVERGE", measure: "PREDICTION / FALLING" },
  "n07-future-self": { title: "FUTURE TRACE", action: "APPROACH", measure: "ARRIVAL / PRE-RECORDED" },
  "n07-evidence-event": { title: "EVENT 13", action: "ANCHOR EVIDENCE", measure: "MASS / CONDITIONAL" },
  "n07-evidence-signal": { title: "SIGNAL 7A", action: "ANCHOR EVIDENCE", measure: "ORIGIN / INTERNAL" },
  "n07-evidence-void": { title: "VOID BOUNDARY", action: "ANCHOR EVIDENCE", measure: "DEPTH / NONLOCAL" },
  "n07-evidence-memory": { title: "MEMORY RECORD", action: "ANCHOR EVIDENCE", measure: "SUBJECT / 07" },
  "n07-bridge-supported": { title: "SUPPORTED MODEL", action: "BUILD GEOMETRY", measure: "EVIDENCE / PLAUSIBLE" },
  "n07-bridge-contradictory": { title: "CONTRADICTORY MODEL", action: "BUILD GEOMETRY", measure: "EVIDENCE / IMPOSSIBLE" },
  "n07-failure-anchor-1": { title: "SAFE ANCHOR 01", action: "HOLD GEOMETRY", measure: "RECONSTRUCTION / ACTIVE" },
  "n07-failure-anchor-2": { title: "SAFE ANCHOR 02", action: "HOLD GEOMETRY", measure: "RECONSTRUCTION / ACTIVE" },
  "n07-failure-anchor-3": { title: "SAFE ANCHOR 03", action: "HOLD GEOMETRY", measure: "RECONSTRUCTION / ACTIVE" },
  "n07-exterior-scan-archive": { title: "ARCHIVE EXTERIOR", action: "SCAN", measure: "VOLUME / IMPOSSIBLE" },
  "n07-exterior-scan-horizon": { title: "NONLOCAL HORIZON", action: "SCAN", measure: "PARALLAX / INVERTED" },
  "n07-exterior-scan-observer": { title: "OBSERVER POSITION", action: "SCAN", measure: "SUBJECT / INCLUDED" },
  "n07-exterior-window": { title: "IMPOSSIBLE WINDOW", action: "OBSERVE", measure: "VIEWPOINT / INTERNAL" },
  "n07-exterior-measure": { title: "EXTERNAL VOLUME", action: "MEASURE", measure: "RATIO / IMPOSSIBLE" },
  "n07-interpret-sector": { title: "MISSING SECTOR", action: "CONSTRUCT", measure: "INTERPRETATION / PHYSICAL" },
  "n07-interpret-archive": { title: "THE ARCHIVE", action: "CONSTRUCT", measure: "INTERPRETATION / PHYSICAL" },
  "n07-interpret-observer": { title: "THE OBSERVER", action: "CONSTRUCT", measure: "INTERPRETATION / PHYSICAL" },
  "n07-interpret-event": { title: "THE EVENT", action: "CONSTRUCT", measure: "INTERPRETATION / PHYSICAL" },
  "n07-observer-direct": { title: "DIRECT RESPONSE", action: "ANSWER", measure: "PREDICTION / ACTIVE" },
  "n07-observer-wait": { title: "WITHHELD RESPONSE", action: "WAIT", measure: "PREDICTION / DECAYING" },
  "n07-route-model": { title: "ARCHIVE MODEL", action: "FOLLOW ROUTE", measure: "COHERENCE / HIGH" },
  "n07-route-contradiction": { title: "CONTRADICTION", action: "FOLLOW ROUTE", measure: "COHERENCE / UNREGISTERED" },
  "n07-traversal": { title: "UNSTABLE INTERVAL", action: "CROSS", measure: "GEOMETRY / TEMPORARY" },
  "n07-final-stabilize": { title: "ARCHIVE MODEL", action: "STABILIZE", measure: "FINAL RESPONSE / OPEN" },
  "n07-final-preserve": { title: "ARCHIVE CONTRADICTION", action: "PRESERVE", measure: "FINAL RESPONSE / OPEN" },
  "n07-return": { title: "NEXUS RETURN", action: "RETURN", measure: "PERSISTENCE / CONFIRMED" },
