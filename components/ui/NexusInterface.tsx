...
const interactionCopy: Record<NexusInteractionId, { title: string; action: string; measure: string }> = {
  ...
  "n07-causal-pre": { title: "PRE-RECORD", action: "PLACE EVENT", measure: "OFFSET / -04.731" },
  "n07-causal-signal": { title: "SIGNAL RESPONSE", action: "PLACE EVENT", measure: "SOURCE / INTERNAL" },
  "n07-causal-containment": { title: "CONTAINMENT CHANGE", action: "PLACE EVENT", measure: "SEQUENCE / UNSTABLE" },
  "n07-causal-arrival": { title: "OBSERVER ARRIVAL", action: "PLACE EVENT", measure: "SEQUENCE / LAST" },
  ...
  "n07-secret": { title: "UNREGISTERED SEAM", action: "EXAMINE", measure: "RECORD / PRE-EXISTING" },
