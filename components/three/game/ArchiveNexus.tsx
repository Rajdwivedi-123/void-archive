...
type Props = { reducedMotion: boolean; discoveredCount: number; session: RealitySnapshot; gateOpening: boolean };
...
export function ArchiveNexus({ reducedMotion, discoveredCount, session, gateOpening }: Props) {
