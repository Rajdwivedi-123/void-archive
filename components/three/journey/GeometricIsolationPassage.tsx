...
type GeometricIsolationPassageProps = { tier: DeviceTier };

export function GeometricIsolationPassage({ tier }: GeometricIsolationPassageProps) {
  const ribs = tier === "mobile" ? [-5.2, 5.2] : [-6.8, -4.9, 4.9, 6.8];
  return (
    <group position={[2.4, 0, -250]}>
